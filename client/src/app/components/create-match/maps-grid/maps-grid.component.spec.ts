...
describe('MapsGridComponent', () => {
  ...
  const mockTileMatrix: any[][] = Array(10).fill(Array(10).fill({}));
  const mockMaps: Map[] = [
    {
      id: 1,
      name: 'Test Map 1',
  ...
  beforeEach(async () => {
    const serviceSpy = jasmine.createSpyObj('MapsForClientService', 
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: MapsForClientService, useValue: serviceSpy }
      ]
    }).compileComponents();
